    ...
    <main>
      ...
      <section className="community-section" id="community">
        <div className="shell community-inner">
          ...
          <div className="community-copy">
            ...
            <a className="button button-light" href="#">Follow TWR on Instagram ↗</a>
          </div>
        </div>
      </section>
      ...
      <footer>
        <div className="shell footer-inner">
          <span>© 2026 TWR</span>
          <div><a href="#delver">Delver</a><a href="#command-tower">Command Tower</a><a href="#community">Instagram</a></div>
